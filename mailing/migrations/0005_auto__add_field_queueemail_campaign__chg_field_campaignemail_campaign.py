...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'QueueEmail.campaign'
        db.add_column(u'mailing_queueemail', 'campaign',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mailing.Campaign'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'CampaignEmail.campaign'
        db.alter_column(u'mailing_campaignemail', 'campaign_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['mailing.Campaign']))

    def backwards(self, orm):
        # Deleting field 'QueueEmail.campaign'
        db.delete_column(u'mailing_queueemail', 'campaign_id')


        # Changing field 'CampaignEmail.campaign'
        db.alter_column(u'mailing_campaignemail', 'campaign_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mailing.Campaign'], null=True))
