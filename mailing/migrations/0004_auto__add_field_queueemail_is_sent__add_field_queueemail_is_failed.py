...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'QueueEmail.is_sent'
        db.add_column(u'mailing_queueemail', 'is_sent',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'QueueEmail.is_failed'
        db.add_column(u'mailing_queueemail', 'is_failed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'QueueEmail.is_sent'
        db.delete_column(u'mailing_queueemail', 'is_sent')

        # Deleting field 'QueueEmail.is_failed'
        db.delete_column(u'mailing_queueemail', 'is_failed')
