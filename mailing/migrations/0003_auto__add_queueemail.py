...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'QueueEmail'
        db.create_table(u'mailing_queueemail', (
        ...
        db.send_create_signal(u'mailing', ['QueueEmail'])


    def backwards(self, orm):
        # Deleting model 'QueueEmail'
        db.delete_table(u'mailing_queueemail')
