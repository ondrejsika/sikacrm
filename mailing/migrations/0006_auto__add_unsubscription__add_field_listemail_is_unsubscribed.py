...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'mailing_unsubscription', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('campaign', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mailing.Campaign'])),
            ('email', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mailing.ListEmail'])),
        ))
        db.send_create_signal(u'mailing', ['Unsubscription'])

        # Adding field 'ListEmail.is_unsubscribed'
        db.add_column(u'mailing_listemail', 'is_unsubscribed',
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'mailing_unsubscription')

        # Deleting field 'ListEmail.is_unsubscribed'
        db.delete_column(u'mailing_listemail', 'is_unsubscribed')
