...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EmailAccountFolder'
        db.create_table(u'crm_emailaccountfolder', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('email_account', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'folder_set', to=orm['crm.EmailAccount'])),
            ('folder', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('last_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'crm', ['EmailAccountFolder'])


    def backwards(self, orm):
        # Deleting model 'EmailAccountFolder'
        db.delete_table(u'crm_emailaccountfolder')
