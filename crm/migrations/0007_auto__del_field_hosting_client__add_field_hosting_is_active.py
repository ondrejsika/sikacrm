...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Hosting.client'
        db.delete_column(u'crm_hosting', 'client_id')

        # Adding field 'Hosting.is_active'
        db.add_column(u'crm_hosting', 'is_active',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Hosting.client'
        raise RuntimeError("Cannot reverse this migration. 'Hosting.client' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Hosting.client'
        db.add_column(u'crm_hosting', 'client',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['crm.Client']),
                      keep_default=False)

        # Deleting field 'Hosting.is_active'
        db.delete_column(u'crm_hosting', 'is_active')
