...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'HostingPayment.description'
        db.alter_column(u'crm_hostingpayment', 'description', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'HostingPayment.description'
        raise RuntimeError("Cannot reverse this migration. 'HostingPayment.description' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'HostingPayment.description'
        db.alter_column(u'crm_hostingpayment', 'description', self.gf('django.db.models.fields.CharField')(max_length=256))
