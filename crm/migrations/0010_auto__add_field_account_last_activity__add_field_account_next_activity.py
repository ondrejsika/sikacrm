...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Account.last_activity'
        db.add_column(u'crm_account', 'last_activity',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Account.next_activity'
        db.add_column(u'crm_account', 'next_activity',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Account.last_activity'
        db.delete_column(u'crm_account', 'last_activity')

        # Deleting field 'Account.next_activity'
        db.delete_column(u'crm_account', 'next_activity')
