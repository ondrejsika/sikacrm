...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Account.tag'
        db.add_column(u'crm_account', 'tag',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['crm.Tag'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Contact.tag'
        db.add_column(u'crm_contact', 'tag',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['crm.Tag'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Case.tag'
        db.add_column(u'crm_case', 'tag',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['crm.Tag'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'EmailConversation.tag'
        db.add_column(u'crm_emailconversation', 'tag',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['crm.Tag'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Account.tag'
        db.delete_column(u'crm_account', 'tag_id')

        # Deleting field 'Contact.tag'
        db.delete_column(u'crm_contact', 'tag_id')

        # Deleting field 'Case.tag'
        db.delete_column(u'crm_case', 'tag_id')

        # Deleting field 'EmailConversation.tag'
        db.delete_column(u'crm_emailconversation', 'tag_id')
