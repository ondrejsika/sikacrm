...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'crm_case', 'state',
                      self.gf('django.db.models.fields.CharField')(default=u'new', max_length=16),
                      keep_default=False)


        # Changing field 'Email.email_to'
        db.alter_column(u'crm_email', 'email_to', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))

    def backwards(self, orm):
        # Deleting field 'Case.state'
        db.delete_column(u'crm_case', 'state')


        # Changing field 'Email.email_to'
        db.alter_column(u'crm_email', 'email_to', self.gf('django.db.models.fields.EmailField')(max_length=256, null=True))
