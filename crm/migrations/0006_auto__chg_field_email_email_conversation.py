...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Email.email_conversation'
        db.alter_column(u'crm_email', 'email_conversation_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['crm.EmailConversation']))

    def backwards(self, orm):

        # Changing field 'Email.email_conversation'
        db.alter_column(u'crm_email', 'email_conversation_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['crm.EmailConversation'], null=True))
