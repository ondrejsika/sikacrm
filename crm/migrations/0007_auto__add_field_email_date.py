...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Email.date'
        db.add_column(u'crm_email', 'date',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2016, 10, 24, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Email.date'
        db.delete_column(u'crm_email', 'date')
