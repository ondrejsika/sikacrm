...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'crm_project', 'client',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['crm.Client']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.client'
        db.delete_column(u'crm_project', 'client_id')
