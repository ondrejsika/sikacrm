...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Contract.start_at'
        db.alter_column(u'crm_contract', 'start_at', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):

        # Changing field 'Contract.start_at'
        db.alter_column(u'crm_contract', 'start_at', self.gf('django.db.models.fields.DateTimeField')())
