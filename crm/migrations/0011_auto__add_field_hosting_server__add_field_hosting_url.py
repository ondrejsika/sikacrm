...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Hosting.server'
        db.add_column(u'crm_hosting', 'server',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=32),
                      keep_default=False)

        # Adding field 'Hosting.url'
        db.add_column(u'crm_hosting', 'url',
                      self.gf('django.db.models.fields.URLField')(default=1, max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Hosting.server'
        db.delete_column(u'crm_hosting', 'server')

        # Deleting field 'Hosting.url'
        db.delete_column(u'crm_hosting', 'url')
    ...
    models = {
        ...
        u'crm.hosting': {
            ...
            'server': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
